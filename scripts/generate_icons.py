...
ICONS = [
    ...
    ("math", "tracks", "A set, written as braces around the elements inside it", [
        '<path d="M9 4C6.5 4 7.5 11 4.5 12C7.5 13 6.5 20 9 20"/>',
        '<path d="M15 4C17.5 4 16.5 11 19.5 12C16.5 13 17.5 20 15 20"/>',
        '<circle cx="12" cy="8" r="1.2" fill="currentColor"/>',
        '<circle cx="12" cy="12" r="1.2" fill="currentColor"/>',
        '<circle cx="12" cy="16" r="1.2" fill="currentColor"/>',
    ]),
    ("math-proof", "tracks", "Three lines of an argument closed by the square that ends a proof", [
        '<path d="M4 6.5h13"/>',
        '<path d="M4 12h10"/>',
        '<path d="M4 17.5h7"/>',
        '<rect x="13" y="15" width="5" height="5" rx="1" fill="currentColor" stroke="none"/>',
    ]),
    ("computer-science", "tracks", "A processor with its pins, where the cost is actually paid", [
    ...
    ("embedding", "tracks", "Points in a space, with near ones grouped", [
        '<circle cx="7" cy="8" r="1.6"/>',
        '<circle cx="10.5" cy="11" r="1.6"/>',
        '<circle cx="17" cy="16.5" r="1.6"/>',
        '<circle cx="19.5" cy="12.5" r="1.6"/>',
        '<path d="M8.2 9.2L9.3 9.9M18.2 15.4L18.9 13.9"/>',
        '<path d="M3.5 20.5V4M3.5 20.5H20"/>',
    ]),
    ("edge-ai", "tracks", "A small model held inside a handheld device", [
        '<rect x="6.5" y="2.5" width="11" height="19" rx="2.5"/>',
        '<rect x="9.5" y="8" width="5" height="5" rx="1"/>',
        '<path d="M9.5 10.5h-1.2M15.7 10.5h-1.2M12 8V6.8M12 14.2V13"/>',
        '<path d="M10.5 19h3"/>',
    ]),
    ("image-generation", "tracks", "Noise on one side resolving into a picture", [
        '<rect x="3" y="5" width="18" height="14" rx="2"/>',
        '<path d="M12 5v14"/>',
        '<path d="M5.5 8h1.5M9 8h1M5.5 11h1M8 11h2M5.5 14h2M9.5 14h.8M5.5 16.5h1.4"/>',
        '<path d="M14 16.5l2.5-3.2 2 2.4 1.5-1.9"/>',
        '<circle cx="15.6" cy="9.2" r="1.15" fill="currentColor"/>',
    ]),
    ...
    ("layers", "ui", "All twenty-six tracks", [
...
SPRITE_HEAD = """{%- comment -%}
Icon sprite for /interview/ and the twenty-six syllabus pages.
