...
(function () {
  ...
  var scenes = {
    ...
    */
    record: {
      narrative: true,
      kicker: 'Jakarta, 2020. A laptop at home',
      title: 'My models still ended when I closed the laptop.',
      copy: 'I was a recent graduate during the pandemic. Most of what I built lived on my laptop, seen by no one and used by no one. I wanted to change that.',
      steps: ['Starting small', 'First proof', 'Responsibility', 'Judgment', 'Research', 'Region', 'Turning point', 'Mission'],
      frames: [
        ['Jakarta, 2020. A laptop at home', 'My work ended when I closed the laptop.', 'I could make a model produce an answer. But no one needed that answer yet. I wanted to build something that mattered beyond my screen.'],
        ['Then came the weekend builds', 'In 48 hours, an idea had to work for someone else.', 'I worked with small teams on simple tools: a phone service for poor internet, remote health checks, and a way to predict where rides were needed. That was my first proof that useful could begin small.'],
        ['Then a city team used my forecast', 'One number could affect a city of 10M+ people.', 'My work helped people decide where public resources should go. The answer no longer disappeared when I closed the laptop. Someone was going to act on it.'],
        ['At a bank, the stakes became personal', 'The systems checked 1M+ identities on a busy day.', 'A mistake could stop someone from reaching an account. I kept the systems running and made each decision easier to check. Within 12 months, I was trusted with more.'],
        ['I began asking a harder question', 'Would my work hold up somewhere it had never seen?', 'I built a tool that found floods in satellite pictures. Then I gave it pictures from another satellite with 6× more detail. It still found the water.'],
        ['Then I looked at who AI was leaving out', 'Much of Southeast Asia was barely visible in its data.', 'I cleaned and sorted 1.28M images from the region. More than 50 researchers across 5 countries helped turn that work into something others could build on.'],
        ['One test changed the direction of my work', 'The AI saw the image, then trusted a false caption instead.', 'For 1 model, that happened 81% of the time. It had the right evidence and still gave the wrong answer. I could no longer treat confidence as proof.'],
        ['That is the work I choose now', 'AI should know when to stop.', 'I study what happens when AI is trained to be safer. My standard is simple: if the evidence is weak, do not bluff. Stop, say what is uncertain, and ask a person.']
      ]
    }
  };
