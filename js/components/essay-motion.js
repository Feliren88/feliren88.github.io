  ...
  var scenes = {
    ...
    */
    record: {
      ...
      title: 'I test AI where mistakes reach real people.',
      copy: 'The record so far: 7 peer-reviewed papers, 1 patent, 12 awards and scholarships, and 5+ years building AI for finance and public services.',
      steps: ['Record', 'Banking systems', 'Built from zero', 'Published research', 'Southeast Asian data', 'Recognition', 'Leadership', 'AI safety'],
      frames: [
        ['Vicky Feliren', 'I test AI where mistakes reach real people.', 'The record so far: 7 peer-reviewed papers, 1 patent, 12 awards and scholarships, and 5+ years building AI for finance and public services.'],
        ['Banking systems', 'I kept banking AI reliable at 1M+ checks a day.', 'On the busiest days, the systems checked more than 1M logins. I kept them available 99.99% of the time and made sure staff could trace every decision during an audit.'],
        ...
        ['What I work on now', 'I found an 81% failure hidden behind a strong AI score.', 'The model followed a false caption even after recognising the image. A second test recovered the correct answer 92% of the time. I now test ways to make AI follow the image or ask a person when the evidence is weak.']
      ]
    }
  };
  ...
  function buildEmotionalNarrativeCanvas(canvas, svg, sceneKey) {
    var stories = {
      ...
      record: {
        ...
        frames: [
          '<g class="em-score"><rect x="62" y="68" width="145" height="104" rx="10"/><text class="em-screen-value" x="134" y="116">7</text><text x="134" y="148">PAPERS</text><rect x="228" y="68" width="145" height="104" rx="10"/><text class="em-screen-value" x="300" y="116">1</text><text x="300" y="148">PATENT</text><rect x="394" y="68" width="145" height="104" rx="10"/><text class="em-screen-value" x="466" y="112">12</text><text x="466" y="140">AWARDS &amp;</text><text x="466" y="158">SCHOLARSHIPS</text><rect x="560" y="68" width="128" height="104" rx="10"/><text class="em-screen-value" x="624" y="116">5+</text><text x="624" y="148">YEARS</text></g><text x="375" y="344">Journals, patent examiners, judges, and real users have tested Vicky’s work.</text>',
