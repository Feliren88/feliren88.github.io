...
(function () {
  ...
  var scenes = {
    ...
    */
    record: {
      narrative: true,
      kicker: 'Jakarta, 2020. No clear way in',
      title: 'So I made the next step smaller.',
      copy: 'I had no job and a growing folder of rejection emails. I stopped trying to solve my whole future. One project, one community, and one weekend at a time gave me evidence that I could move.',
      steps: ['Closed door', 'Small paths', 'Consequence', 'Missing map', 'Conflict', 'The work now'],
      frames: [
        ['Jakarta, 2020. No clear way in', 'Rejection began to feel like a verdict.', 'I graduated into a pandemic with no internship, weak interview skills, and no useful network. I kept trying to solve my whole future at once.'],
        ['Then I made the problem smaller', 'Several rough paths created movement.', 'I built a project, joined technical communities, and entered weekend hackathons. One small project eventually led to my first job.'],
        ['The first job changed what a score meant', 'Every output landed somewhere.', 'A waste forecast moved city resources. A bank score reached a person’s account. Accuracy had consequences outside the model.'],
        ['The maps kept showing unfamiliar ground', 'Missing data had names and places.', 'Satellite sensors shifted across regions. Southeast Asian languages and images were absent from common tests. I started looking for failures hidden by averages.'],
        ['Then the image and caption disagreed', 'The model answered anyway.', 'A system can hold useful evidence and still speak with false confidence. That gap made uncertainty feel like a safety problem.'],
        ['Now I study the stopping point', 'Can safety preserve honest doubt?', 'I measure how safety training changes calibration across languages and input types. Then I test when a model should stop and ask for review.']
      ]
    }
  };
  ...
  function buildEmotionalNarrativeCanvas(canvas, svg, sceneKey) {
    var stories = {
      ...
      /* Six drawings for /about/. A single signal line changes meaning across the
         story: route, model trace, missing boundary, and finally a deliberate stop. */
      record: {
        label: 'Vicky moves from unemployment through small experiments and consequential machine learning work to research on when AI should stop',
        frames: [
          '<rect class="em-screen" x="72" y="60" width="340" height="220" rx="12"/><text class="em-screen-label" x="242" y="94">APPLICATIONS</text><g class="em-requests"><rect x="108" y="120" width="268" height="34" rx="6"/><rect x="108" y="170" width="268" height="34" rx="6"/><rect x="108" y="220" width="268" height="34" rx="6"/></g><g class="em-fig em-fig-edge"><circle class="em-head" cx="590" cy="170" r="23"/><path class="em-person" d="M590 193v70m-36 54 36-54 36 54"/><path class="em-person em-arm" d="M590 218l-48 22"/></g><path class="em-pull" d="M412 172C470 176 500 216 542 228"/><text x="375" y="344">Every closed door began to look like the whole future.</text>',
          '<g class="em-load"><rect x="64" y="70" width="150" height="48" rx="7"/><text x="139" y="99">one project</text><rect x="300" y="54" width="150" height="48" rx="7"/><text x="375" y="83">one team</text><rect x="536" y="70" width="150" height="48" rx="7"/><text x="611" y="99">one weekend</text></g><path class="em-road" d="M138 118C180 214 276 214 375 102C474 214 570 214 612 118"/><circle class="em-attempt-next" cx="375" cy="190" r="18"/><path class="em-arrow" d="M375 208v78m-14-18 14 18 14-18"/><rect class="em-result-mark" x="282" y="286" width="186" height="38" rx="19"/><text class="em-result-word" x="375" y="310">MOVEMENT</text><text x="375" y="344">Small paths moved when the perfect one would not.</text>',
          '<rect class="em-screen" x="52" y="66" width="230" height="164" rx="10"/><text class="em-screen-label" x="167" y="100">CITY FORECAST</text><path class="em-road" d="M82 196l42-34 36 18 38-54 52 30"/><path class="em-arrow" d="M298 150h82m-18-14 18 14-18 14"/><rect class="em-note" x="398" y="64" width="288" height="224" rx="10"/><text class="em-note-title" x="434" y="100">BANK DECISION</text><path class="em-note-rule" d="M434 126h216M434 174h216M434 222h216"/><g class="em-fig em-fig-holder"><circle class="em-head" cx="542" cy="254" r="18"/><path class="em-person" d="M542 272v44m-26 24 26-24 26 24"/></g><text x="375" y="344">The number left the screen and entered someone’s life.</text>',
          '<path class="em-road" d="M74 244C130 130 216 118 292 208S460 286 676 92"/><path class="em-broken" d="M150 98l52 52m0-52-52 52"/><path class="em-broken" d="M472 108l52 52m0-52-52 52"/><g class="em-clusters"><circle cx="110" cy="244" r="14"/><circle cx="258" cy="194" r="14"/><circle cx="410" cy="248" r="14"/><circle cx="588" cy="150" r="14"/></g><rect class="em-result-mark" x="266" y="64" width="218" height="42" rx="21"/><text class="em-result-word" x="375" y="90">WHO IS MISSING?</text><text x="375" y="344">A clean average hid unfamiliar ground.</text>',
          '<rect class="em-screen" x="62" y="58" width="220" height="154" rx="9"/><text class="em-screen-label" x="172" y="90">IMAGE</text><path class="em-road" d="M86 184l46-44 34 28 38-54 52 70"/><rect class="em-message" x="62" y="232" width="220" height="64" rx="9"/><text class="em-result-word" x="172" y="270">CAPTION</text><path class="em-broken" d="M302 150l54 54m0-54-54 54"/><path class="em-arrow" d="M380 178h70m-18-14 18 14-18 14"/><rect class="em-note" x="472" y="112" width="226" height="126" rx="12"/><text class="em-result-word" x="585" y="164">CONFIDENT</text><text class="em-result-word" x="585" y="194">AND WRONG</text><text x="375" y="344">The evidence conflicted. The model answered anyway.</text>',
          '<path class="em-road" d="M62 180h250"/><circle class="em-attempt-old" cx="112" cy="180" r="13"/><circle class="em-attempt-old" cx="182" cy="180" r="13"/><circle class="em-attempt-old" cx="252" cy="180" r="13"/><path class="em-broken" d="M336 112v136"/><rect class="em-result-mark" x="384" y="84" width="292" height="68" rx="18"/><text class="em-result-word" x="530" y="125">STOP · ASK · REVIEW</text><path class="em-open-gate" d="M384 180h292M530 180v108"/><g class="em-fig em-fig-stand"><circle class="em-head" cx="530" cy="230" r="20"/><path class="em-person" d="M530 250v52m-30 38 30-38 30 38"/></g><text x="375" y="344">Now I work on making that stopping point reliable.</text>'
        ]
      },
      uncertainty: {
