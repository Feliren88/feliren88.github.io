...
(function () {
  ...
  var objectives = {
    ...
    correct: ['Correct', 'Describe the situation, behaviour, and impact. State what must change next.'],
        ...
        : said <= 3 && shared < 40
          ...
          : said > 18 && shared < 55
            ...
            : shared > 70
              ...
              : 'The message fits the channel. Ask them to summarise before you add more.';
    }
  ...
  function manualLibrary() {
    ...
    function lessonVisual(n, title) {
      ...
      var structured = {
        ...
        27:['Listen','Affirm','Respond','Add information'],30:['Situation','Observable behaviour','Impact'],
        ...
        75:['Explain','Responsibility','Regret','Repair','Prevent repeat','Request forgiveness'],76:['Acknowledgment','Repair','Changed behaviour'],
