...
<header class="cq-hero" aria-labelledby="cq-title">
  ...
  <div class="cq-hero-copy">
    <p class="cq-kicker">A field manual for unfinished understanding</p>
    <h1 id="cq-title">Reality may contain something<br><i>I have not understood yet.</i></h1>
    <p>Notice the gap. Investigate it. Change your mind when the evidence earns it.</p>
  </div>
...
<section class="cq-part cq-prose" id="questions">
  ...
  <div class="cq-ladder" id="cq-ladder">
    ...
    <button type="button" data-step="4"><span>05</span><b>What am I not seeing?</b><small>Search for absent people, data, and costs.</small></button>
    <button type="button" data-step="5"><span>06</span><b>What can I test cheaply?</b><small>Trade speculation for contact with reality.</small></button>
  </div>
...
<section class="cq-part cq-prose" id="practice">
  ...
  <div class="cq-rhythm">
    ...
    <article><span>Weekly · 20 min</span><h3>Review</h3><p>Which belief changed? Which question deserves a deeper test?</p></article>
    <article><span>Monthly · 1 field trip</span><h3>Explore</h3><p>Enter one unfamiliar subject, place, or conversation.</p></article>
