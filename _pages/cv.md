...
<article class="cv-page">
  ...
  <nav class="cv-nav" aria-label="CV sections"><a href="#publications">Publications</a><a href="#education">Education</a><a href="#experience">Experience</a><a href="#research-service">Teaching & service</a><a href="#skills">Skills</a><a href="#recognition">Recognition</a></nav>

  <section class="cv-section" id="publications"><header><span>01</span><h2>Selected publications</h2></header><div class="cv-list cv-list--compact">
    {% assign cv_publications = 'encp-vln,sea-vl,commonlid,flood-procanet' | split: ',' %}
    {% for pub_key in cv_publications %}{% assign pub = site.data.publications | where: 'key', pub_key | first %}{% if pub %}<article><time>{{ pub.year }}</time><div><h3><a href="{{ pub.url }}" target="_blank" rel="noreferrer">{{ pub.title }}</a></h3><p class="cv-location">{{ pub.tag }} · {{ pub.venue }}</p><p>{{ pub.description }}</p></div></article>{% endif %}{% endfor %}
    <a class="about-inline-cta" href="/research/">View the full publication record <span aria-hidden="true">→</span></a>
  </div></section>
  ...
  <section class="cv-section" id="experience"><header><span>03</span><h2>Research and professional experience</h2></header><div class="cv-list">
  ...
  <section class="cv-section" id="research-service"><header><span>04</span><h2>Teaching, speaking and service</h2></header><div class="cv-columns">
  ...
  <section class="cv-section" id="skills"><header><span>05</span><h2>Technical skills</h2></header><div>
  ...
  <section class="cv-section" id="recognition"><header><span>06</span><h2>Recognition</h2></header><div class="cv-recognition-body"><div class="cv-awards">
  ...
  <footer class="cv-footer"><p>Read the research question behind this work.</p><a class="btn btn-primary" href="/">About</a><a class="btn btn-secondary" href="/contact/">Contact me</a></footer>
</article>
